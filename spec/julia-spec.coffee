describe "Julia grammar", ->
  ...
  it "tokenizes imaginary unit", ->
    ...
    expect(tokens[4]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[5]).toEqual value: '+',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[6]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[7]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[8]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[9]).toEqual value: '-',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[10]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[11]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[12]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[13]).toEqual value: '*',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[14]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    ...
    expect(tokens[17]).toEqual value: '/',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[18]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[19]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[20]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[21]).toEqual value: '^',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[22]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[23]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[24]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[25]).toEqual value: '\\',     scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[26]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
