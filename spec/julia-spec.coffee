describe "Julia grammar", ->
  ...
  it "tokenizes types ignoring whitespace", ->
    ...
    expect(tokens[29]).toEqual value: ")", scopes: ["source.julia"]
  ...
  it "tokenizes everything related to `:` (ranges, symbols, subtyping)", ->
    ...
    expect(tokens[3]).toEqual value: '; a',    scopes:  ["source.julia"]
    expect(tokens[4]).toEqual value: ':',      scopes:  ["source.julia", "keyword.operator.range.julia"]
    expect(tokens[5]).toEqual value: 'b; c',   scopes:  ["source.julia"]
    expect(tokens[6]).toEqual value: ':',      scopes:  ["source.julia", "keyword.operator.range.julia"]
    expect(tokens[7]).toEqual value: ' d; e ', scopes:  ["source.julia"]
    expect(tokens[8]).toEqual value: ':f',     scopes:  ["source.julia", "constant.other.symbol.julia"]
    expect(tokens[9]).toEqual value: '; ',     scopes:  ["source.julia"]
    expect(tokens[10]).toEqual value: ':g',    scopes:  ["source.julia", "constant.other.symbol.julia"]
    expect(tokens[11]).toEqual value: ':',     scopes:  ["source.julia", "keyword.operator.range.julia"]
    expect(tokens[12]).toEqual value: ' ',     scopes:  ["source.julia"]
    expect(tokens[13]).toEqual value: ':h',    scopes:  ["source.julia", "constant.other.symbol.julia"]
  ...
  it "tokenizes imaginary unit", ->
    {tokens} = grammar.tokenizeLine('2im 2img 3+im 3-im 3*im 3/im 3^im 3\im')
    ...
    expect(tokens[4]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[5]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[6]).toEqual value: '+',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[7]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[8]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[9]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[10]).toEqual value: '-',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[11]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[12]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[13]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[14]).toEqual value: '*',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[15]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[16]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[17]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[18]).toEqual value: '/',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[19]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[20]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[21]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[22]).toEqual value: '^',      scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[23]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[24]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[25]).toEqual value: '3',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[26]).toEqual value: '\\',     scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[27]).toEqual value: 'im',     scopes:  ["source.julia", "constant.numeric.julia"]
