describe "Julia grammar", ->
  ...
  it "tokenizes types ignoring whitespace", ->
    ...
    expect(tokens[3]).toEqual value: " ", scopes: ["source.julia"]
    expect(tokens[4]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
    ...
    expect(tokens[10]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
    ...
    expect(tokens[15]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
    ...
    expect(tokens[20]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
    ...
    expect(tokens[26]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes functions and (shallowly nested) parameterized types", ->
    ...
    expect(tokens[8]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes extension of external methods", ->
    ...
    expect(tokens[6]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it 'tokenizes string macro after type operator', ->
    ...
    expect(tokens[0]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it 'tokenizes string macro after type operator in short form func definiton', ->
    ...
    expect(tokens[0]).toEqual value: "f", scopes: ["source.julia", "entity.name.function.julia"]
    expect(tokens[1]).toEqual value: "(", scopes: ["source.julia", "meta.bracket.julia"]
    expect(tokens[2]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes nested interpolated expressions in double strings", ->
    ...
    expect(tokens[2]).toEqual value: "(", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
    ...
    expect(tokens[14]).toEqual value: ")", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
  ...
  it "tokenizes interpolated nested parentheses", ->
    {tokens} = grammar.tokenizeLine('"$(a(()))"')
    expect(tokens[0]).toEqual value: '"', scopes: ["source.julia", "string.quoted.double.julia", "punctuation.definition.string.begin.julia"]
    expect(tokens[1]).toEqual value: "$(", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia"]
    expect(tokens[2]).toEqual value: "a", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "support.function.julia"]
    expect(tokens[3]).toEqual value: "(", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
    expect(tokens[4]).toEqual value: "(", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
    expect(tokens[5]).toEqual value: ")", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
    expect(tokens[6]).toEqual value: ")", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia", "meta.bracket.julia"]
    expect(tokens[7]).toEqual value: ")", scopes: ["source.julia", "string.quoted.double.julia", "variable.interpolation.julia"]
  ...
  it "tokenizes short form function definitions with `where` syntax", ->
    ...
    expect(tokens[7]).toEqual value: "where", scopes: ["source.julia","keyword.other.julia"]
    expect(tokens[8]).toEqual value: "  T", scopes: ["source.julia"]
    expect(tokens[9]).toEqual value: "<:", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes long form function definitions with `where` syntax", ->
    ...
    expect(tokens[5]).toEqual value: "::", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
    ...
    expect(tokens[10]).toEqual value: "  T", scopes: ["source.julia"]
    expect(tokens[11]).toEqual value: "<:", scopes: ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes everything related to `:` (ranges, symbols, subtyping)", ->
    ...
    expect(tokens[22]).toEqual value: '::',    scopes:  ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes type", ->
    ...
    expect(tokens[1]).toEqual value: '>:',    scopes:  ["source.julia", "keyword.operator.relation.types.julia"]
  ...
  it "tokenizes multiplied mathematical constants", ->
    {tokens} = grammar.tokenizeLine('2pi 2π')
    expect(tokens[0]).toEqual value: '2pi',    scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[1]).toEqual value: ' ',      scopes:  ["source.julia"]
    expect(tokens[2]).toEqual value: '2π',      scopes:  ["source.julia", "constant.numeric.julia"]
  ...
  it 'tokenizes numbers with a transpose', ->
    {tokens} = grammar.tokenizeLine('2im\'+2')
    expect(tokens[0]).toEqual value: '2im',      scopes:  ["source.julia", "constant.numeric.julia"]
    expect(tokens[1]).toEqual value: '\'',        scopes:  ["source.julia", "keyword.operator.conjugate-number.julia"]
    expect(tokens[2]).toEqual value: '+',        scopes:  ["source.julia", "keyword.operator.arithmetic.julia"]
    expect(tokens[3]).toEqual value: '2', scopes:  ["source.julia", "constant.numeric.julia"]
